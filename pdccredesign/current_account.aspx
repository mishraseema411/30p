<%@ Page Language="C#" AutoEventWireup="true" CodeFile="current_account.aspx.cs" Inherits="current_account" %>
...
#az {
    ...
    <div class="container">
        ...
        <a href="Accounts deposit.aspx" style="color:#EFBC40">Accounts And Deposits</a> > <a href="account.aspx"style="color:#EFBC40">Accounts</a> > <a href="#"style="color:#e9ab45" >Current Account</a>
      <br>
       ...
       <br>
        ...
        <div class="contact agileits"id="az">
            <div class="container">
                ...
                <div class="col-md-4 contact-right wthree">
                    <img src="images/document.jpg" width="400" height="350">
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
