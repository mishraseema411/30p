...
<body>
    <head:Header runat="server" ID="header1" />
        <hr />
<section id="testimonial" style="font-family:Verdana;">
...
<div class="container">
	...
	<div class="row">
        ...
        <div role="tabpanel">
            ...
            <div class="col-sm-9">
                <div class="tab-content" style="background-color:#F9F8F3;padding:8px 8px 8px 8px;">
                    <div role="tabpanel" class="tab-pane active" id="tab1">
                      
                           <h2> Pune Profile </h2>
                           <hr>
                           <h5>
                           <p>Surrounded with hills and lakes, the picturesque city of Pune is the pride of west India. It is the cultural capital of the state of Maharashtra. The cultural and intellectual capacity of Pune has earned it the title of being the ‘Oxford of the East.’ Pune is 192 km from Mumbai & situated on Mumbai Banglore National Highway (NH-4).</p>
                           </h5>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div id="blog-post" class="owl-carousel">
							<div>
								<div class="block">
									<img src="images/loan/personal.jpg" alt="" class="img-responsive"/>
									<div class="content">
										<h4><a href="blog.html">Personal Loan</a></h4>
										<small> </small>
										...
										<br /><p><a href="#" class="btn btn-read">Know More</a>
							...
							<div>
								<div class="block">
									<img src="images/loan/gold.jpg" alt="" class="img-responsive"/>
									<div class="content">
										<h4><a href="blog.html">Gold Loan</a></h4>
										<small></small>
										...
										<p><a href="#" class="btn btn-read">Know More</a>
										<a href="#" class="btn btn-read">Apply Online</a></p>
							...
							<div>
								<div class="block">
									<img src="images/loan/consumer.jpg" alt="" class="img-responsive"/>
									<div class="content">
										<h4><a href="blog.html">Consumer Loan</a></h4>
										<small></small>
							...
							<div>
								<div class="block">
									<img src="images/loan/education.jpg" alt="" class="img-responsive"/>
									<div class="content">
										<h4><a href="blog.html">Education Loan</a></h4>
										<small></small>
							...
							<div>
								<div class="block">
									<img src="images/loan/vehicle.jpg" alt="" class="img-responsive"/>
									<div class="content">
										<h4><a href="blog.html">Vehicle Loan</a></h4>
										<small></small>
                            ...
                            <div>
								<div class="block">
									<img src="images/loan/business.jpg" alt="" class="img-responsive"/>
									<div class="content">
										<h4><a href="blog.html">Business Loan</a></h4>
										<small></small>
                            ...
                            <div>
								<div class="block">
									<img src="images/loan/housing.jpg" alt="" class="img-responsive"/>
									<div class="content">
										<h4><a href="blog.html">Housing Loan</a></h4>
										<small></small>
            ...
            <div class="row">
                ...
                <div class="col col-md-6 hovcolor1">
                    <div class="media wow fadeInLeft" data-wow-delay=".3s">
                        <div class="media-left">
                            <a href="#">
                                <img src="emi.png" alt="" style="height: 78px; width: 78px;">
                            </a>
                        </div>
                ...
                <div class="col col-md-6 hovcolor2">
                    <div class="media wow fadeInRight" data-wow-delay=".3s">
                        <div class="media-left">
                            <a href="#">
                                <img src="invest.png" alt="" style="height: 78px; width: 78px;">
                            </a>
                        </div>
                        <div class="media-body">
                            <a href="#">
                ...
                <div class="col col-md-6 hovcolor3">
                    <div class="media wow fadeInLeft" data-wow-delay=".3s">
                        <div class="media-left">
                            <a href="#">
                                <img src="access.png" alt="" style="height: 78px; width: 78px;">
                            </a>
                        </div>
                        <div class="media-body">
                            <a href="#">
                ...
                <div class="col col-md-6 hovcolor4">
                    <div class="media wow fadeInRight" data-wow-delay=".3s">
                        <div class="media-left">
                            <a href="#">
                                <img src="security.png" alt="" style="height: 78px; width: 78px;">
                            </a>
                        </div>
                        <div class="media-body">
                            <a href="#">
    ...
    <div class="services">
        <div class="container">
            ...
            <p>
                We always believes in customer satisfaction and endeavors to provide value added services to the customers of the Bank.
                <br>
                Your voice is our wisdom. Visit your nearest branch for voicing out your opinion or contact us now.
            </p>
