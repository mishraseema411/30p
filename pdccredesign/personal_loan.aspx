...
<body>
   <head:Header runat="server" ID="header1" />
    ...
    <!--====================================================
                  PERSONAL LOAN
======================================================--> 
    <section id="service-h" style="background:#F8DB56  ;">
        <div class="container-fluid">
          <div class="row" >
            <!--<div class="col-md-4 pdtop wow fadeInUp" data-wow-delay="0.3s"  >
               
                <img src="images/loan/personalloan.jpg" alt="" class="img-responsive"/ style="height:300px; width:400px;">
             
            </div>-->
            <div class="col-md-offset-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="service-h-desc">
                <h2 class="w3ls_head"><span>Personal Loan</span> </h2>

               <p style="color:#4B493D  ;">Dreaming of a vacation, a perfect wedding, home renovation or a much desired gadget, you no longer need to wait to realize your dreams. 
				</p>
				<p style="padding-bottom:20px;color:#4B493D  ;">Make life picture perfect with PDCC Bank Personal Loans.</p> 
				<p style="padding-bottom:20px;padding-left:-20px;"><a href="#" class="btn btn-buy" style="color:#F50A1B;">Apply Online</a></p>
              <div class="service-h-tab"> 
                <nav class="nav nav-tabs" id="myTab" role="tablist">
                  <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-expanded="true" style="padding:10px 20px;color:#4B493D;border:1px solid #000;">Benefits</a>
                  <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" style="padding:10px 20px;color:#4B493D  ;border:1px solid #000;">Documents Required</a> 
                  <a class="nav-item nav-link" id="my-profile-tab" data-toggle="tab" href="#my-profile" role="tab" aria-controls="my-profile" style="padding:10px 20px;color:#4B493D  ;border:1px solid #000;">Terms And Conditions</a> 
                </nav>
                <div class="tab-content" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      <ul style="color:#4B493D  ;">
